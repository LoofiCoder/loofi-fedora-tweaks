...
from services.virtualization.disposable_vm import DisposableVMManager  # noqa: E402


class TestDisposableVMPaths(unittest.TestCase):
    """Tests for storage directory and base image path helpers."""

    @patch('services.virtualization.disposable_vm.os.makedirs')
    @patch('services.virtualization.disposable_vm.os.path.expanduser', return_value="/home/test/.local/share/loofi-vms/disposable")
...
class TestLaunchDisposable(unittest.TestCase):
    ...
    @patch('services.virtualization.disposable_vm.DisposableVMManager.is_base_image_available', return_value=False)
...
class TestCleanupDisposable(unittest.TestCase):
    ...
    @patch('services.virtualization.disposable_vm.os.remove')
    @patch('services.virtualization.disposable_vm.os.path.isfile', return_value=True)
