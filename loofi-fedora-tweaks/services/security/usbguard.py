...
Migrated from utils/usbguard.py in v2.0.0.
"""
...
class USBGuardManager:
    ...
    def install(cls) -> Result:
        ...
        try:
            binary, args, desc = PrivilegedCommand.dnf("install", "usbguard", "usbguard-tools")
    ...
    def list_devices(cls) -> list[USBDevice]:
        ...
        try:
            result = subprocess.run(["usbguard", "list-devices"], capture_output=True, text=True, timeout=10)
