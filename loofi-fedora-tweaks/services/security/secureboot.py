...
Migrated from utils/secureboot.py in v2.0.0.
"""
...
class SecureBootManager:
    ...
    def sign_module(cls, module_path: str) -> SecureBootResult:
        ...
        if not sign_file:
            return SecureBootResult(False, "sign-file utility not found. Install kernel-devel package.")
        ...
        try:
            ...
            if result.returncode == 0:
                return SecureBootResult(success=True, message=f"Module signed successfully: {module_path}")
            else:
