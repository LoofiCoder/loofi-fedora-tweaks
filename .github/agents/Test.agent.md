...
description: Testing specialist for Loofi Fedora Tweaks v2.11.0. Creates comprehensive unit tests following project conventions with proper mocking of system calls.
