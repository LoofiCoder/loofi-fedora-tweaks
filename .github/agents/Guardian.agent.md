...
description: Quality assurance and testing specialist for Loofi Fedora Tweaks v2.2.2. Creates comprehensive test suites, validates code quality, and ensures all features are properly tested.
...
- **Test suite**: 237 test files, 80% coverage (CI-enforced)
