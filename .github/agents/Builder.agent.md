...
description: Backend implementation specialist for Loofi Fedora Tweaks v2.6.0. Builds utils/ business logic modules with proper dataclasses, error handling, and system integration.
...
- **Scale**: 107 utils modules, 241 test files, 80% coverage (CI-enforced)
