...
description: General-purpose code implementation agent for Loofi Fedora Tweaks v2.4.0. Implements features, fixes bugs, and makes code changes following project architecture.
