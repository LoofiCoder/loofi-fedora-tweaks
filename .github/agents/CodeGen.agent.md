...
description: General-purpose code implementation agent for Loofi Fedora Tweaks v2.2.2. Implements features, fixes bugs, and makes code changes following project architecture.
